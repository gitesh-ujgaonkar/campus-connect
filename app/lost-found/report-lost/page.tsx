        ...
        <div className="max-w-2xl mx-auto">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Fill out the form below with details about your lost item. The more information you provide, the better chance of someone finding it.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleSubmit}>
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    />
                    <p className="text-xs text-muted-foreground">Upload a clear image of the item (max 5MB)</p>
            ...
            <CardFooter className="bg-muted/50 flex flex-col items-start text-sm text-muted-foreground">
              <p>* Required fields</p>
              <p className="mt-1">
                Note: Your contact information will be visible to others so they can reach out if they find your item.
              </p>
            </CardFooter>
          </Card>
        </div>
